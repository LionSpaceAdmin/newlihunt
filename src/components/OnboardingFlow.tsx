        ...
        content: (
          <div className="text-center">
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              Scam Hunter uses advanced AI to analyze suspicious content and protect you from online
          ...
          <div className="space-y-4">
            <div className="flex items-start space-x-4 p-4 bg-dark-gray rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">
                  Get both Risk Score (0-100) and Credibility Score (0-100) for comprehensive
                  assessment
                </p>
              </div>
            </div>
        ...
        content: (
          <div className="text-center">
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              You&apos;re all set! Start by typing a message, uploading an image, or pasting a
    ...
    steps: [
      {
        ...
        content: (
          <div className="text-center">
            ...
            <p className="text-gray-300 leading-relaxed mb-4">
              צייד הרמאויות משתמש בבינה מלאכותית מתקדמת כדי לנתח תוכן חשוד ולהגן עליכם מפני רמאויות
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-dark-gray rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] flex flex-col">
        ...
        {/* Content */}
        <div className="flex-1 overflow-y-auto p-6">{currentStepData.content}</div>
