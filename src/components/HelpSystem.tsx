  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-accent-blue text-white rounded-full shadow-lg hover:bg-blue-600 transition-all duration-200 hover:scale-110 z-50"
        title="Help & Guidance"
      >
